...
if has("cscope")
    ...
    " thing as hitting 'escape': CTRL-_ doesn't seem to have any default use).
    " If you don't like using 'CTRL-_' or CTRL-\, , you can change some or all
    ...
    " Using 'CTRL-spacebar' (intepreted as CTRL-_ by vim) then a search type
